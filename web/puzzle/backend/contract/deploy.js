...
const { harmony, myAccount } = require('./harmony')
const { compileContract } = require('./compile')
const { logOutput } = require('./util')

async function checkMyAccount(account) {
...
async function deploy(file, gasLimit, gasPrice, nonce, amount, compileTo) {
