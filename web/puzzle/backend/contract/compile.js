...
function getFileNameAndPath(file) {
...
function getPaths(filePath, fileName, importFile) {
...
function constructInput(fullRelativePath, file) {
...
function compileContract(fileLocation, jsonFile, contractFolder = 'contracts') {
